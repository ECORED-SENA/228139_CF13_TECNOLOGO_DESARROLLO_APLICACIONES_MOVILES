...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    h5.mb-4(data-aos="fade") Para realizar el ejemplo del evento listener de un Button, se deben seguir algunos pasos que se presentan a continuación.
    ...
    AcordionA.mb-5(tipo="a" clase-tarjeta="tarjeta bg-4" data-aos="fade-down")
      ...
      .row.justify-content-center(titulo="2. En la clase Java declarar el tipo de <em>view</em> y referenciarlo.")
        ...
        .col-lg-11
          ...
          p Cada clase tiene relacionado su #[em layout] en el método setContentView por lo tanto se debe referenciar los #[em view] en cada clase que lo contenga, en el ejemplo la clase Java MainActivity contiene al #[em layout] activity_main que fue donde se creó el Button.
      ...
      .row.justify-content-center(titulo=" 3. Implementar el evento <em>listener</em>.")
        ...
        .col-lg-11
          ...
          p.mb-4 Los View tiene diferentes métodos escuchadores, en la tabla que se encuentra a continuación se pueden observar los más utilizados:
          .table-a.mt-4
