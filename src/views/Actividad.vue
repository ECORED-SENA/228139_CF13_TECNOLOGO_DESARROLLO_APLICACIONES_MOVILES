    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        .titulo-segundo.color-acento-contenido
          h2 Componentes <em>back-end</em> de la aplicación móvil
        p.mb-4 Afianzar algunos de los conceptos más importantes sobre las tiendas de publicación para aplicaciones móviles.
